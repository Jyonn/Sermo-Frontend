...
function AuditConversation({ chat, hasMore, loading, messages, onLoadOlder, onMessage }: { chat: ChatDTO; hasMore: boolean; loading: boolean; messages: ChatMessageDTO[]; onLoadOlder: () => Promise<void>; onMessage: (message: ChatMessageDTO) => void }) {
