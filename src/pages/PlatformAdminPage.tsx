...
function PlatformAdminLogin() {
  ...
  return <main className="platform-login">
    <section className="platform-login-card">
      <div className="platform-brand"><img alt="" className="platform-brand-mark" src="/icons/frienden-512.png?v=1"/><div><small>FRIENDEN CONTROL</small><strong>平台审计台</strong></div></div>
